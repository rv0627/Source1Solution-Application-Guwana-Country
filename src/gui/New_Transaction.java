 ...
 * @author SAVEEN
 */
public class New_Transaction extends javax.swing.JDialog {
     ...
     */
    public New_Transaction(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        this.setTitle("Source 1 Solutions - New Transaction");
    ...
    private void generateInvoiceID() {
        ...
        try {
            ResultSet resultSet = MySQL.execute("SELECT * FROM `invoice` ORDER BY `invoice_id` DESC LIMIT 1");
            if (resultSet.next()) {
        ...
        int numericPart = Integer.parseInt(lastInvoiceID.substring(3));
        numericPart++;

        // Customize the employee ID format
        invoiceID = String.format("INV%05d", numericPart);
    ...
    private void shippingMode() {
        try {
            ...
            vector.add("Select Shipping Mode");
...
//            taxes = Double.parseDouble(jFormattedTextField10.getText());
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1087, 720));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        jLabel3.setText("New Transaction");
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)))
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jFormattedTextField14, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (qty.isEmpty()) {
            ...
            invoiceItem.setWebsiteTotal(websiteTotal);

            if (invoiceItemMap.get(description) == null) {
                invoiceItemMap.put(description, invoiceItem);
            } else {

                InvoiceItem found = invoiceItemMap.get(description);
    ...
    private void loadInvoiceItem() {
        ...
        for (InvoiceItem invoiceItem : invoiceItemMap.values()) {
            ...
            vector.add(invoiceItem.getQuantity());

            double itemTotal = Double.parseDouble(invoiceItem.getQuantity()) * Double.parseDouble(invoiceItem.getWebsiteTotal());
            total += itemTotal;
    ...
    private void resetTransactionTab() {
        jTextField1.setText(invoiceID);
        jTextField2.setText("");
        jTextField2.grabFocus();
        jFormattedTextField1.setText("");
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    invoiceItemMap.remove(description);
        ...
        if (mobile.isEmpty()) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    //open report
                    mi.loadInvoices("", "", "invoice_id", "ASC");
                    generateInvoiceID();
                    resetTransactionTab();
                } else {
                ...
                MainInterface.logger.log(Level.WARNING, "Print Invoice", e);
                //e.printStackTrace();
            }
