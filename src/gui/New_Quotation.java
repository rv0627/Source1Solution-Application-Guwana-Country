 ...
 * @author SAVEEN
 */
public class New_Quotation extends javax.swing.JDialog {
    ...
    /**
     * Creates new form NewQuatation
     */
    public New_Quotation(java.awt.Frame parent, boolean modal, String qutID) {
        super(parent, modal);
        initComponents();
        ...
        if (Qi.row != -1) {
            viewComponents();
            selectedQutID = qutID;
            generateQuotationID("invoice", "invoice_id");
            paymentMethod();
            ...
            hideComponents();
            selectedQutID = "";
            generateQuotationID("quotation", "quotation_id");
        }
    }

    private String lastQuotationID;
    private String lastInvoiceID;
    String quotationID;
    String invoiceID;

    private void generateQuotationID(String tableName, String column) {

        try {
            ResultSet resultSet = MySQL.execute("SELECT * FROM `" + tableName + "` ORDER BY `" + column + "` DESC LIMIT 1");
            if (resultSet.next()) {
                if (tableName.equals("quotation")) {
                    lastQuotationID = resultSet.getString("quotation_id");
                } else {
                    lastInvoiceID = resultSet.getString("invoice_id");
                }
            } else {
                if (tableName.equals("quotation")) {
                    lastQuotationID = "QUT00000";
                } else {
                    lastInvoiceID = "INV00000";
                }
            }
        ...
        if (tableName.equals("quotation")) {
            int numericPart1 = Integer.parseInt(lastQuotationID.substring(3));
            numericPart1++;

            // Customize the employee ID format
            quotationID = String.format("QUT%05d", numericPart1);

            jTextField1.setText(quotationID);
        } else {
            int numericPart2 = Integer.parseInt(lastInvoiceID.substring(3));
            numericPart2++;

            // Customize the employee ID format
            invoiceID = String.format("INV%05d", numericPart2);
    ...
    private void hideComponents() {
        ...
        jFormattedTextField13.setVisible(false);
        jFormattedTextField14.setVisible(false);
    ...
    private void viewComponents() {
        jLabel3.setText("Convert to Invoice");
        ...
        jFormattedTextField13.setVisible(true);
        jFormattedTextField14.setVisible(true);
    ...
    private void paymentMethod() {
        try {
            ResultSet resultSet = MySQL.execute("SELECT * FROM `payment_method` ORDER BY `payment_method_id` ASC");
            Vector<String> vector = new Vector<>();
            vector.add("Select payment method");
            while (resultSet.next()) {
                vector.add(resultSet.getString("method"));
                paymentMethodMap.put(resultSet.getString("method"), resultSet.getInt("payment_method_id"));
            }
            DefaultComboBoxModel model = new DefaultComboBoxModel(vector);
...
//            taxes = Double.parseDouble(jFormattedTextField10.getText());
        ...
        if (jFormattedTextField13.getText().isEmpty()) {
            paidAmount = 0;
        } else {
            paidAmount = Double.parseDouble(jFormattedTextField13.getText());
        }

        balance = paidAmount - Grandtotal;
        double roundedBalance = Math.round(balance);
        jFormattedTextField14.setText(String.valueOf(roundedBalance));
    ...
    private void resetQuotationTab() {
        generateQuotationID("quotation", "quotation_id");
        jTextField1.setText(quotationID);
        jTextField2.setText("");
    ...
    private void loadConvertDetails() {
        try {
            ...
            while (resultSet.next()) {
                ...
                jDateChooser1.setDate(resultSet.getDate("quotation.estimated_date_of_arrival"));

                jComboBox1.setSelectedIndex(resultSet.getInt("quotation.mode_of_shipment_mode_of_shipment_id"));
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1071, 670));
        setResizable(false);
        ...
        jButton2.setText("Print Quotation");
        ...
        jFormattedTextField14.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        jButton3.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jButton3.setText("Convert to invoice");
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel22)
                    .addComponent(jFormattedTextField13, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel23)
        ...
        jLabel12.setText("Estimated time of arrival");
        ...
        jLabel13.setText("Mode of Shipment");
        ...
        jLabel24.setText("Select payment method");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String shippMode = String.valueOf(jComboBox1.getSelectedItem());
        ...
        if (mobile.isEmpty()) {
            ...
            String estimatedDate = format1.format(jDateChooser1.getDate());
            ...
            try {
                ...
                if (resultSet.next()) {
                    String cusID = resultSet.getString("customers.customer_id");

                    //add to invoice
                    MySQL.execute("INSERT INTO `quotation` (`quotation_id`,`customers_customer_id`,`estimated_date_of_arrival`,"
                            + "`mode_of_shipment_mode_of_shipment_id`,`sub_total`,`item_weight`,`handling`,`duties`,`taxes`,`estimated_shipping`,`grand_total`,"
                            + "`employee_employee_id`,`quotation_date`)"
                            + "VALUES ('" + qutID + "','" + cusID + "','" + estimatedDate + "',"
                            + "'" + shippModeId + "','" + subTotalAmount + "','" + itemweight + "','" + handlingAmount + "',"
                            + "'" + dutiesAmount + "','" + taxAmount + "','" + estimatedShippingAmount + "','" + gradTotal + "','" + MainInterface.empID + "','" + quotationRegisterDate + "')");
                    ...
                    for (QuotationItem item : quotationItemMap.values()) {
                        MySQL.execute("INSERT INTO `quotation_item` (`description_of_item`,`quantity`,`website_total`,`quotation_quotation_id`)"
                                + "VALUES ('" + item.getDescription() + "','" + item.getQuantity() + "','" + item.getWebsiteTotal() + "','" + qutID + "')");
                    }
                    //add to invoice Item

                    //open report
                    //String path = "src//reports//source1solution_Quotation.jasper";
                    ...
                    JOptionPane.showMessageDialog(this, "Quotation created.", "Success", JOptionPane.INFORMATION_MESSAGE);
                    //open report
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String note = "Converted to invoice";
        ...
        String dutiesAmount = jFormattedTextField9.getText();
        String taxAmount = jFormattedTextField10.getText();
        String paid_Amount = jFormattedTextField13.getText();
        String gradTotal = jFormattedTextField12.getText();
        ...
        if (mobile.isEmpty()) {
            ...
            if (jScrollPane6 != null) {
                Rectangle rect = jDateChooser1.getBounds();
                jScrollPane6.getViewport().scrollRectToVisible(rect);
            }
            ...
            if (jScrollPane6 != null) {
                Rectangle rect = jComboBox2.getBounds();
                jScrollPane6.getViewport().scrollRectToVisible(rect);
            }
        } else if (shippMode.equals("Select Shipping Mode")) {
            JOptionPane.showMessageDialog(this, "Please select shipping method.", "Warning", JOptionPane.WARNING_MESSAGE);
            jComboBox1.grabFocus();
            if (jScrollPane6 != null) {
                Rectangle rect = jComboBox1.getBounds();
                jScrollPane6.getViewport().scrollRectToVisible(rect);
            }
        } else if (tableTotal.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Not added the invoice item.", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (itemweight.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter item weight.", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (handlingAmount.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter handling amount.", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            String estimatedDate = format1.format(jDateChooser1.getDate());
            int shippModeId = shipModeMap.get(shippMode);
            int paymentMethodId = paymentMethodMap.get(paymentMethod);

            Date date1 = new Date();
            String invoiceRegisterDate = format1.format(date1);
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    //add to invoice
                    MySQL.execute("INSERT INTO `invoice` (`invoice_id`,`customers_customer_id`,`estimated_date_of_arrival`,"
                            + "`mode_of_shipment_mode_of_shipment_id`,`sub_total`,`item_weight`,`handling`,`duties`,`taxes`,`grandTotal`,"
                            + "`paid_ammount`,`employee_employee_id`,`payment_method_payment_method_id`,`reference_no`,`invoice_date`)"
                            + "VALUES ('" + invID + "','" + cusID + "','" + estimatedDate + "',"
                            + "'" + shippModeId + "','" + subTotalAmount + "','" + itemweight + "','" + handlingAmount + "',"
                            + "'" + dutiesAmount + "','" + taxAmount + "','" + gradTotal + "','" + paid_Amount + "','" + MainInterface.empID + "','" + paymentMethodId + "','" + refNo + "','" + invoiceRegisterDate + "')");

                    //add to invoice
                    //add to invoice Item
                    for (QuotationItem item : quotationItemMap.values()) {
                        MySQL.execute("INSERT INTO `invoice_item` (`description_of_item`,`quantity`,`website_total`,`invoice_invoice_id`)"
                                + "VALUES ('" + item.getDescription() + "','" + item.getQuantity() + "','" + item.getWebsiteTotal() + "','" + invID + "')");
                    }
                    //add to invoice Item

                    //add to coverttable
                    MySQL.execute("INSERT INTO `converttoinvoice` (`quotation_quotation_id`,`invoice_invoice_id`,`notice`)"
                            + "VALUES ('" + selectedQutID + "','" + invID + "','" + note + "')");
                    //add to coverttable

                    //open report
                    //String path = "src//reports//source1solution_Invoice.jasper";
                    InputStream reportStream = MainInterface.class.getResourceAsStream("/reports/source1solution_Invoice_New.jasper");
                    URL imageUrl = MainInterface.class.getResource("/img/IMG_report.jpg");
                    ...
                    parameters.put("Parameter6", invoiceRegisterDate);
                    parameters.put("Parameter7", jFormattedTextField3.getText());
                    parameters.put("Parameter8", jFormattedTextField12.getText());
                    parameters.put("Parameter9", String.valueOf(jComboBox2.getSelectedItem()));
                    parameters.put("Parameter10", jFormattedTextField13.getText());
                    parameters.put("Parameter11", jFormattedTextField14.getText());

                    parameters.put("Parameter12", jFormattedTextField4.getText());
                    parameters.put("Parameter13", jFormattedTextField5.getText());
                    parameters.put("Parameter14", jFormattedTextField7.getText());
                    parameters.put("Parameter15", jFormattedTextField8.getText());
                    parameters.put("Parameter16", jFormattedTextField9.getText());
                    parameters.put("Parameter17", jFormattedTextField10.getText());
                    parameters.put("Parameter18", jFormattedTextField11.getText());
                    ...
                    //open report
                    JOptionPane.showMessageDialog(this, "Coverted success.", "Success", JOptionPane.INFORMATION_MESSAGE);
                ...
                MainInterface.logger.log(Level.WARNING, "Convert to invoice", e);
                //e.printStackTrace();
            }
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    String description = String.valueOf(jTable1.getValueAt(row, 0));
                    String total = String.valueOf(jTable1.getValueAt(row, 2)); // Assuming total is in column 2
